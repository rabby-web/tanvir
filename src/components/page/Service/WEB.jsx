      ...
      >
        <a href="#">
          <img
            ...
            src="https://img.freepik.com/free-vector/laptop-with-program-code-isometric-icon-software-development-programming-applications-dark-neon_39422-971.jpg?t=st=1707275472~exp=1707276072~hmac=fd5c6b922ed54cdb80a8386dc2b7667effa385c272eb2169b91bd2a1475937f2"
            alt=""
          />
        </a>
        <div class="p-5">
            ...
            <p className="py-4 text-lg">
              <span className="p-1 flex gap-3">
                ...
                <div>
                  ...
                  Creating websites optimized for various devices and screen
                  sizes to deliver a seamless user experience.
                </div>
              </span>
              <span className="p-1 flex gap-3">
                <HiOutlineChevronDoubleRight className="text-4xl font-bold text-violet-800 dark:text-purple-600" />
                <div>
                  <span className="text-lg font-semibold">UI/UX:</span> User
                  Interface (UI) & User Experience (UX) Design: Designing
                  intuitive layouts and navigation structures to enhance
              ...
              <span className="p-1 flex gap-3">
                ...
                <div>
                  ...
                  Developing websites using platforms like WordPress, Shopify,
                  or custom CMS solutions tailored to client needs.
                </div>
              </span>
              <span className="p-1 flex gap-3">
                <HiOutlineChevronDoubleRight className="text-4xl font-bold text-violet-800 dark:text-purple-600" />
                <div>
                  ...
                  Optimizing website speed, secure
                </div>
              </span>
            </p>
